...
describe('The Queries API ', () => {
  ...
  let queryString = '?state=cbd0a696-2b4f-4469-85d1-f7027345e3e0&genres=87fc3814-4cb9-43a5-b723-63ecebd65c5a,cdc3d520-8b74-46ac-9f4c-8f27d04ab49f&languages=9d5741e1-b482-4027-8c57-45193073ef12&entityType=olyplat-entity-movie';
  let filters = [
  ...
  it('_makeQueryObject should convert a filters collection to a query object', () =>
    expect(queriesApi._makeQueryObject(filters)).to.eql(queryObject));
