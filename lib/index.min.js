  ...
  _createClass(_class, [{
    ...
    value: function activateProxyHookSubscriptions() {
      ...
      _onSelectedViewChange$.subscribe(function (_ref) {
        ...
        if (selectedView) {
          //  BehaviorSubjects initialize
          onSelectedViewChange$.next({ selectedView: selectedView, state: state,
            replaceItems: function replaceItems(_ref2) {
              var items = _ref2.items,
                  _ref2$idProp = _ref2.idProp,
                  idProp = _ref2$idProp === undefined ? 'id' : _ref2$idProp,
    ...
    value: function selectView(id) {
      ...
      this.hooks._onSelectedViewChange$.next({ selectedView: id, state: state });
